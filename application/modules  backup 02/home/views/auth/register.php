...
<form action="<?= base_url('home/auth/register'); ?>" method="POST" class="form-signin" style="margin-bottom: 200px;">
  <div class="card p-4">
    ...
    <div class="input-group mb-3">
      ...
      <input type="password" class="form-control" placeholder="Konfirmasi Password" name="re_password" placeholder="Password">
    </div>


    <button type="submit" class="btn btn-primary btn-block">Login</button>
    <br>
    <p>Sudah punya akun? <a href="<?= base_url('home/auth'); ?>">Login di sini</a></p>
