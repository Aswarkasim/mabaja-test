      ...
      foreach ($paket as $row) { ?>
        ...
        <div class="col-md-4 mt-2">
          <div class="card">
            <div class="card-body">
              <img src="<?= base_url('assets/img/blank_image.jpg'); ?>" width="100%" alt="">
              <h6 class="mt-2"><strong><?= $row->nama_paket; ?></strong></h6>

              <a href="<?= base_url('home/paket/' . $row->id_paket); ?>" class="btn btn-primary btn-block mt-1">Buka</a>
            </div>
          </div>
        </div>
